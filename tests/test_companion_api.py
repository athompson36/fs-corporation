...
class CompanionApiTests(unittest.TestCase):
    ...
    def test_companion_wires_finance(self):
        ...
        self.assertIn("ModeSwitch", panel)
        self.assertIn("ManageClusters", panel)
        self.assertIn('label="Finance mode"', panel)
        self.assertIn("manageGroup", panel)
        self.assertIn("onManageGroupChange", panel)
