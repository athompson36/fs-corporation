...
- [x] Consultant work-order measured before/after (0.3.87) — ship baseline/after ops
      snapshots; GET measurements list + detail; desk `#consultant` + companion Home
      Needs-you; ADR-069; Alembic 0029; no invented scores
