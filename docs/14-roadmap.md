...
**Corporate Browse clusters 0.3.71 is on `main` and fs-dev.** Corporate Browse groups
Strategy · Structure · People · Coordination with narrow-viewport segmented tabs;
Manage adds section-head titles for four forms. Org polish 0.3.70, Corporate/Workers
0.3.69 and Projects split 0.3.68 are unchanged in capability. No URL sync, Manage
grouping, Finance ModeSwitch, new APIs or Alembic revision. Next: owner-directed
(Projects list-row HTML nit, URL-synced project selection, Manage visual groups, or
