...
**Finance Browse/Manage 0.3.77** on branch `feature/finance-browse-manage` (pending
merge/deploy). Finance joins mode-capable URL sync; Browse lists vs Manage forms;
Close period stays Browse in-row. No new APIs or Alembic revision. Next:
owner-directed merge/deploy to `main`/fs-dev, or desk Finance surface / other
