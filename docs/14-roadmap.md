...
**Finance Browse/Manage 0.3.77 is on `main` and fs-dev** (tip `5b21dcd`). Finance
joins mode-capable URL sync; Browse lists vs Manage forms; Close period stays
Browse in-row. No new APIs or Alembic revision. Next: owner-directed (desk
Finance surface, polish nits, or other companion follow-ups).
