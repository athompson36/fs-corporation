...
**Desk Finance surface 0.3.78 is on `main` and fs-dev** (tip `a1be7cb`). Desk
`#budget` expands to Finance summary/lists/forms/close; section id unchanged;
no ModeSwitch or new APIs. Next: owner-directed polish nits (dead
