...
**Desk remaining session gates 0.3.85** ships on branch
`feature/desk-remaining-session-gates`. Division Activate, promotions, staffing, and
dispatch submit/recommend fail-closed from first paint; version lockstep at 0.3.85.
Next: Ship 2 finance B + consultant B (brainstorm/plan separately).
