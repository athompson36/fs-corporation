...
**Companion finance URL polish 0.3.79 is on `feature/companion-finance-url-polish`
(pending merge).** Close period stays on Browse; cold-load/popstate use
mode-aware group defaults; `urlState` harness runs from unittest discover. Next:
