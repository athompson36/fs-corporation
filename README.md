...
| CEO desk and headquarters projection | Persisted grid floorplans and department rooms render in 2D with requirement warnings; expansion-event isometric remains the fallback; room selection opens persisted organization/work data |
