...
**Deliverable status: v0.3.11 isometric HQ projection + sourced SLO catalog + fail-closed Web Push + feed/GitHub/container lifecycles + mobile companion + fs-dev deployment.** This is not a finished autonomous company. Live ChatDev, GitHub, market feeds, billed models, push delivery, and documentation fetch are not connected.
...
| CEO desk and headquarters projection | Local HTML/SVG 2D plan plus isometric tiles from persisted expansion rooms; reduced motion respected |
