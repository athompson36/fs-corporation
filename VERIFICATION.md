...
Updated 2026-09-08 for **0.3.56** (remote pull agent; P5 UI chrome; P4) and Corporate HQ Phases 1–8.
...
- Alembic revision chain is linear and single-headed: `0001_initial` through
  `0023_ceo_scorecard`.
- Companion **0.3.56** build completes (`generateSW`) and emits the production PWA assets.
