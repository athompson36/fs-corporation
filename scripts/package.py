...
Build output: dist/fs-corporation-cursor-starter.zip
"""
import hashlib
...
out=root/'dist'/'fs-corporation-cursor-starter.zip'
out.parent.mkdir(exist_ok=True)
with zipfile.ZipFile(out,'w',zipfile.ZIP_DEFLATED) as z:
    for p in files:
        info=zipfile.ZipInfo('fs-corporation/'+p.relative_to(root).as_posix(),date_time=(2026,9,1,0,0,0))
